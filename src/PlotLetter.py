...
elif file_path.split('/')[lastIndex].split('.')[2] == "android" or "Adamo":
    shift_x = 0
    shift_y = 1
    error = 0.02
    fToA = 9.81
...
axs[0].set_ylabel('PositionZ (m)')
axs[1].scatter(position[0], position[1], marker = ".")
axs[1].set_xlabel('PositionX')
axs[1].set_ylabel('PositionY')
plt.show()